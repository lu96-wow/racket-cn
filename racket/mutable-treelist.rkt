...
(rename-define
  ...
  [mutable-treelist-append! 可变-树列表-拼接!]
  [mutable-treelist-cons! 可变-树列表-对!]
  [mutable-treelist-prepend! 可变-树列表-前插!]
  [mutable-treelist-first 可变-树列表-首]
  [mutable-treelist-last 可变-树列表-尾]
  [mutable-treelist-take! 可变-树列表-取前!]
  [mutable-treelist-drop! 可变-树列表-去掉前!]
  [mutable-treelist-take-right! 可变-树列表-取后!]
  [mutable-treelist-drop-right! 可变-树列表-去掉后!]
  ...
  [mutable-treelist-for-each 可变-树列表-遍历]
  [mutable-treelist-sort! 可变-树列表-排序!]
